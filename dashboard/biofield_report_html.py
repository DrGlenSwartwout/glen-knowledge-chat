...
def render_invoice_page(report, fee_state):
    ...
    handoff = (
        ...
        "<p class=food>One click stages both for Rae: the authored analysis is pushed to "
        ...
        "proposed order. Rae reviews and publishes both from the console &mdash; nothing is "
        ...
        "if(j.ok){b.textContent='Handed off \\u2713';var iv=j.invoice||{};"
        ...
        "m+='. Rae can review + publish both now.';s.textContent=m;}"
