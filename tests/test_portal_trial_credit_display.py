...
def _seed_trial_with_orders(appmod, email):
    ...
    subs.init_subscriptions_table(cx); subs.migrate_add_membership_columns(cx); subs.migrate_add_term_cap_column(cx); subs.migrate_add_attribution_column(cx); subs.migrate_add_consent_column(cx)
